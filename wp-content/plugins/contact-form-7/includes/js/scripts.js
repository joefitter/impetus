(function($) {
		...
		try {
			...
			$('div.wpcf7 > form').ajaxForm({
				...
				success: function(data) {
					...
					window._messageTimeout = setTimeout(function(){
						$(data.into).wpcf7ClearMessage()
					}, 5000);
				},
	...
	$.fn.wpcf7AjaxLoader = function() {
		return this.each(function() {
			var self = this;
			var button = $('<button class="ladda-button" data-color="orange" data-style="slide-up"><span class="ladda-label">' + $(this).val() + '</span><span class="ladda-spinner"></span></button>');
	...
	$.fn.wpcf7ClearResponseOutput = function() {
		return this.each(function() {
			clearTimeout(window._messageTimeout);
			$(this).find('div.wpcf7-response-output').slideUp("fast", function(){
				$(this).empty().removeClass('wpcf7-mail-sent-ok wpcf7-mail-sent-ng wpcf7-validation-errors wpcf7-spam-blocked');
			});
