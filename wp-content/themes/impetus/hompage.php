...
<div id="projects-top">
	<div class="wrapper">
		...
		<p class="projects-strapline grey center">Reducing isolation &bull; Securing access to statutory services &bull; Enabling positive choices</p>
	</div>
</div>
<div class="thin-grey"></div>
<div class="wrapper" id="main">
	<div id="content">
		<h2 class="projects green">We help</h2>
...
<div class="clear"></div>
		...
		<div class="project-teaser left">
			...
			<p>We welcome new volunteers.</p>
			<p>You can donate directly to us.</p>
			<div class="teaser-button full-width">
				...
				<a class="view-project half right" href="/donate">Donate <?php echo get_right_arrow_HTML(); ?></a>
				<div class="clear"></div>
			</div>
		</div>
	<div class="clear"></div>
